...
const print = {
    ...
    header: () => {
        print.separator();
        console.log(`${colors.bold}🚀 Configurador Gênesis Kyara - Versão ${version}${colors.reset}`);
...
async function main() {
    ...
    let config = {
        ...
        github_ofc: 'https://github.com/DevTokyoVx/kyara',
        autor: 'DevTokyoVx',
        repositorio: 'kyara',
        modoaluguel: off,
    ...
    print.message(`🎉 Kyara configurado e pronto para uso! Versão: ${version}`);
}
