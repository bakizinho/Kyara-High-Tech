    ...
    if (userData.xp >= nextLevelXp) {
      ...
      if (nazu && from) {
        ...
        try {
          const levelUpImages = [
            'dados/midias/level-up.jpg',
            'dados/midias/level-up.png',
            'dados/midias/level-up.webp',
            'dados/midias/subiu-de-nivel.jpg',
            'dados/midias/subiu-de-nivel.png',
            'dados/midias/subiu-de-nivel.webp'
          ];
          ...
          if (levelUpImage) {
            ...
            nazu.sendMessage(
              ...
              console.log(
                '[LEVEL UP IMAGE] Imagem enviada:',
                levelUpImage
              );
            }).catch(err => {
              console.error(
                '[LEVEL UP IMAGE] Falha ao enviar imagem:',
                err.message
              );

              /*
               * Se a imagem falhar, manda o texto.
               */
             ...
             * Nesse caso o sistema continua funcionando
             * normalmente com a mensagem de texto.
             */
            nazu.sendMessage(
              from,
              {
              ...
              console.error(
                '[LEVEL UP] Erro ao enviar mensagem:',
                err.message
              );
            });
          }

        } catch (levelImageError) {

          console.error(
            '[LEVEL UP IMAGE] Erro:',
            levelImageError.message
          );

          /*
           * Fallback absoluto para texto.
           */
          nazu.sendMessage(
            from,
            {
